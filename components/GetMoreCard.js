...
const GetMoreCard = ({label,subtitle,icon}) => {
  return (
    <View style={{ gap: 10 }} className="flex-row shadow-lg rounded-lg p-4 bg-white overflow-hidden mb-7">
      {/* icon */}
      <View className="bg-yellow-400 rounded-full self-start p-3">
        {icon}
      </View>
      <View className="">
        <Text className=" text-xl font-semibold text-cyan-800 tracking-wider">{label}</Text>
